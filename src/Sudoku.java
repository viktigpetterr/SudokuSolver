...
public class Sudoku {
	 ...
	 * 
	 * @param row
	 *            - specifies row for the wanted place in the matrix.
	 * @param col
	 *            - specifies column for the wanted place in the matrix.
	 * 
	 ...
	 * 
	 * @param row
	 *            - specifies row for which the value shall be set in the
	 *            matrix.
	 * @param col
	 *            - specifies column for which the value shall be set in the
	 *            matrix.
	 * @param value
	 *            - The value which is to be set in the matrix.
	 * 
	 * @return Nothing is returned.
	 */
	 ...
	 * 
	 * @param row
	 *            - The row where the check will start.
	 * @param col
	 *            - The column where the check will start.
	 * 
	 ...
	 * 
	 * @param row
	 *            - The row where the solving shall begin.
	 * @param col
	 *            - The column where the solving shall begin.
	 * 
